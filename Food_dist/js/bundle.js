...
function calc() {
    ...
    function initLocalSeteing(selector, activeClass) {
    ...
    initLocalSeteing('#gender div', 'calculating__choose-item_active');
    initLocalSeteing('.calculating__choose_big div', 'calculating__choose-item_active');
...
function modal(triggerSelector, modalSelector, modalTimerId) {
    ...
    const modalTrigger = document.querySelectorAll(triggerSelector), //Дата атрибуты указываются в квадратных скобках!!!!!!!!
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', '2022-03-29');
